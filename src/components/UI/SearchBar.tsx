...
const SearchBar = () => {
  return (
    <div className="flex items-center flex-col md:flex-row justify-between bg-white p-5 rounded-lg shadow-md lg:w-[50%] w-full lg:ml-20 ml-0 md:mt-32 mt-8 gap-4 md:gap-0 z-30">
