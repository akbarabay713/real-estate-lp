const SearchBar = () => {
  return (
    <div className="flex items-center flex-col md:flex-row justify-between bg-white p-5 rounded-lg shadow-md lg:w-[50%] w-full lg:ml-20 ml-0 lg:mt-32 -mt-10 md:mt-10 gap-4 md:gap-0 z-30">
      <div className="flex items-center justify-between md:flex-row flex-col gap-3">
        ...
        <div className="flex flex-col w-full md:w-auto">
          <div className="flex gap-6 w-full md:w-auto items-center">
            <div className="bg-[#4C28B53D] w-[1px] h-3 hidden md:block"></div>
            <img src="house.svg" alt="house" />
            <div className="flex flex-col w-full md:w-[9.75rem]">
